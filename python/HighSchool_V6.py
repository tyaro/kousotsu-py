...
def main():
    ...
    for pair in PairList.keys():
        ...
        RSI56 = round(dfHours.iloc[-1][RSI_56_],1)
        RSI56BTC = round(dfHoursBTC.iloc[-1][RSI_56_],1)

        # ジャッジメントですの
        Judge,spoint,lpoint = HighSchool.JudgementDesno2(lastPrice,EntryPointShort,EntryPointLong,RSI56)
        ...
        l = [
             ...
             (str(RSI56)).ljust(4)+"/"+(str(RSI56BTC).ljust(4)), # RSI(14)
            ]
        ...
        cryptoInfoData['RSI14'] = RSI56
        cryptoInfoData['RSI14BTC'] = RSI56BTC
